    ...
    <div className='bg-gray-900/80 border-y-gray-800 shadow-inner shadow-black/20'>
      <div className='max-w-8xl mx-auto px-4 lg:px-8 overflow-x-auto scrollbar-hide'>
        <div className='flex space-x-4 py-3 items-center'>
          <div className='flex items-center text-lg font-bold text-yellow-400 pr-3'>
          ...
          {featuredArea.map((area) =>
            <Link
              ...
              px-4 rounded-full bg-gray-800 border-gray-700 hover:bg-blue-600 hover:shadow-lg
